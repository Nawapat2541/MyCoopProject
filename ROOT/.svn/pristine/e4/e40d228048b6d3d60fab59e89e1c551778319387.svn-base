						...
						<div class="col-md-1"></div>
							...
							<div class="col-md-4">
								<input type="text" name="name" class="form-control" id="nameid"
									maxlength="240" value="${holidayrecord.head}" required>
				...
				<div class="col-md-1"></div>
					...
					<div class="col-md-4">
						<textarea style="word-break: break-all; white-space: normal;"
						 class="form-control"  rows="5" cols="100"  name="description" id="text1"  ></textarea>
						<div class="form-control-focus"></div>
					</div>
				</div>
				...
				<div class="col-md-1"></div>
					...
					<div class="col-md-4">
						<center>
							...
							<button type="button" class="btn red" onclick="ss()">
